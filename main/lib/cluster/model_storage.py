...
class storage4cluster():
	def __init__(self, model_name='',  user="", password="", database="", host_address='', port='1433'):
	...
	def read_model_blob(self):
		...
		sql_cmd = "SELECT model FROM cluster_model WHERE model_name = %s ORDER BY reporttime DESC"
